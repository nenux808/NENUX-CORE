...
# Ollama context/runtime budgets.
MODEL_CONTEXT_TOKENS = _env_int("NENUX_MODEL_CONTEXT", 8192)
TOOL_RESULT_CONTEXT_CHARS = _env_int("NENUX_TOOL_RESULT_CONTEXT_CHARS", 6000)
